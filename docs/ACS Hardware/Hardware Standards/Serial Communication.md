...
On initialization, reset, etc., devices always connect to the bus at a baud rate of 100KHz. After enumeration, the Core may define a new baud rate if all attached devices report they support it.
