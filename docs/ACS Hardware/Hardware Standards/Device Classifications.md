...
A Switch is a device type that is intended as a primary interface between an ACS deployment and the equipment, space, etc. it is intending to control access to.